...
namespace ThirdParty.DebugDrawingExtension.Example{
    public class Example : MonoBehaviour{
        ...
        void OnDrawGizmos(){
            ...
            if (debugCylinder)
                DebugExtension.DrawCylinder(new Vector3(40, 0, 0), debugCylinder_End, debugCylinder_Color,
                    debugCylinder_Radius);
            if (debugCone)
            ...
            if (debugCapsule)
                DebugExtension.DrawCapsule(new Vector3(70, 0, 0), debugCapsule_End, debugCapsule_Color,
                    debugCapsule_Radius);
        ...
        void Update(){
            ...
            DebugExtension.DebugCylinder(new Vector3(40, 0, 0), debugCylinder_End, debugCylinder_Color,
                debugCylinder_Radius);
            ...
            DebugExtension.DebugCapsule(new Vector3(70, 0, 0), debugCapsule_End, debugCapsule_Color,
                debugCapsule_Radius);
        }
    }
}